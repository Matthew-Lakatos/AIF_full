...
class PCRL_Whittington(nn.Module):
    ...
    # from its own predictive-coding error, not on `reward`. Comparing its
    ...
    REWARD_SOURCE = "self-supervised pseudo-reward (predictive-coding error proxy), not raw environment reward"
